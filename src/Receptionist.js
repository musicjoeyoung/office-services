      ...
      <div className="receptionist">
        ...
        <div className="rolesDiv">
          <p className="roles">
            ...
            Operations Manager and is responsible for the security, cleanliness,
            and orderly operation of the Reception area and providing each
            employee and guest with a professional, vibrant, welcoming and
            overall exceptional customer service experience.
          </p>
        </div>
        <div className="parentDiv">
          ...
          <div className="parent">
            ...
            <p id="fourthIndent">
              b. If an employee does not give you a departure time, you can make
              the call of how much time to add - 2 hours from arrival time is
              usually adequate.
            </p>
            <p id="thirdIndent">
            ...
            <p id="firstIndent">
              ...
              <strong>high-profile persons with armed-security details</strong>{" "}
              with them that the Security and Office Services Ops. Manager
              knows, at ext. 4489. He will accompany/escort those individuals in
              and out of the building.
            </p>
            <p id="firstIndent">c. Registering Employees without badges</p>
            <p id="secondIndent">
              i. If there is a new employee or an employee without a badge, the
              Receptionist should reference the Employee Directory in UltiPro to
              verify employment, before registering (or call Human Resources).
            </p>
            <p id="secondIndent">
              ii. If an employee does not have their ID, please also let John
              Daniels know. This excludes new hires if they have yet to receive
              a temporary badge.
            </p>
            ...
            <p id="firstIndent">
              ...
              forwarded to.{" "}
              <em>
                (Most of the time the message will go Listener Services @ x4000)
              </em>
            </p>
            <p id="firstIndent">
            ...
            <p id="firstIndent">
              c. Send confirmation e-mail to the employee, their supervisor, and
              the Security and Office Services Ops. Manager
            </p>
